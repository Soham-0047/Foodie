      ...
      >
        ...
        >
          <Flex flexWrap="wrap" alignItems="start" justifyContent="space-between">
            <Box w={{ base: '100%', md:'50%', md: 'max-content' }} mb={{ base: '1rem', lg: '0' }}>
            ...
            <Box w={{ base: '100%', sm: '50%', md: 'max-content' }} mb={{ base: '1.5rem', lg: '0' }}>
              <Heading as="h5" fontSize="19px" fontWeight="600" color="#0E2368">
                Contact Us
              </Heading>
              <Box w="55%" marginTop="1rem" color="#646874" >
                <Text lineHeight="2"  >
              Lorem Ipsum Pvt Ltd.5/1, Magalton Road, Phartosh Gate near YTM Market, XYZ-343434
              </Text>

              <Text marginTop="1rem">example2020@gmail.com</Text>
              <Text marginTop="1rem">+919907653213</Text>
              </Box>
              
              
            </Box>
            <Box w={{ base: '100%', sm: '50%', md: 'max-content' }} mb={{ base: '1.5rem', lg: '0' }}>
            <Heading fontSize="19px" fontWeight="600" color="#0E2368">More</Heading>
              <List lineHeight="10">
            ...
            <Box w={{ base: '100%', sm: '50%', md: 'max-content' }} mb={{ base: '1.5rem', lg: '0' }}>
              <Heading fontSize="19px" fontWeight="600" color="#0E2368">Social Links</Heading>
              <Flex justifyContent="space-evenly" mb="0.5rem" mt="1rem" alignItems="baseline" gap="5" >
                <Link href="#" mr="0.5rem">
                  <svg
